<template>
  <div class="container mt-5">
    ...
    <DataTable :value="submittedCards" showGridlines tableStyle="min-width: 50rem">
...
const validateResident = (blur) => {
  if (!formData.value.isAustralian) {
    if (blur) errors.value.isAustralian = 'You must be an Australian Resident to continue.'
  } else {
...
const validateReason = (blur) => {
  ...
  if (!text) {
    ...
    if (blur) errors.value.reason = 'Reason must contain at least five characters.'
  } else {
